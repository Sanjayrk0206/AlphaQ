...
do
        ...
        then
                ...
                then
                        ln -s /home/Jay_Jay/future.txt /home/"${User[$i]}0$p_no"/future.txt #linking statement
                fi
        else
                L=/home/"${User[$i]}$p_no"/future.txt
                if [ ! -f "$L" ] #checks file exist or not
                then
                        ln -s /home/Jay_Jay/future.txt /home/"${User[$i]}$p_no"/future.txt #linking statement
                fi
        fi
